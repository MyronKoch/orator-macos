/// Vendored from sherpa-onnx (k2-fsa), swift-api-examples/SherpaOnnx.swift.
/// Copyright (c) 2023 Xiaomi Corporation. Apache-2.0. Upstream:
/// https://github.com/k2-fsa/sherpa-onnx
///
/// Local change vs upstream: `import SherpaOnnxC` added below. Upstream compiles
/// this with a bridging header (`-import-objc-header SherpaOnnx-Bridging-Header.h`);
/// SwiftPM targets can't use bridging headers, so we import the `SherpaOnnxC`
/// clang module vended by the SherpaOnnxMacOS binary xcframework instead.

import Foundation  // For NSString
import SherpaOnnxC  // C API from the sherpa-onnx xcframework (see Package.swift)
